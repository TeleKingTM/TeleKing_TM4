...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    return '🔐 Arabic/Persian Posting Is Already UnLocked\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔓'
  else
...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'yes' then
    return '🔐 Add Member Is Already Locked\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔐'
  else
    data[tostring(target)]['settings']['lock_member'] = 'yes'
    save_data(_config.moderation.data, data)
  end
  return '🔐 Add Member Has Been Locked\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔐'
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    return '🔐 Add Member Is Not Locked\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔓'
  else
    data[tostring(target)]['settings']['lock_member'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔐 Add Member Has Been UnLocked\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔓'
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    return '🔐 Settings Are Already Strictly Enforced Created By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔐'
  else
    data[tostring(target)]['settings']['strict'] = 'yes'
    save_data(_config.moderation.data, data)
    return '🔐 Settings Will Be Strictly Enforced Created By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔐'
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    return '🔐 Settings Are Not Strictly Enforced Created By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔓'
  else
    data[tostring(target)]['settings']['strict'] = 'no'
    save_data(_config.moderation.data, data)
    return '🔐 Settings Will Not Be Strictly Enforced Created By @To_My_Amigos\nOur Channel @AntiSpam_TM 🔓'
  end
end
...
function get_message_callback(extra, success, result)
	...
	elseif get_cmd == 'mute_user' then
		...
		if is_muted_user(chat_id, user_id) then
			...
			send_large_msg(receiver, "["..user_id.."] Removed From The Silented User List\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM")
		elseif is_admin1(msg) then
			mute_user(chat_id, user_id)
			send_large_msg(receiver, " ["..user_id.."] Added To The Silented User List\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM")
		end
	end
end
...
local function callbackres(extra, success, result)
  ...
  elseif get_cmd == "invite" then
	...
	elseif get_cmd == 'mute_user' then
		...
		if is_muted_user(chat_id, user_id) then
			unmute_user(chat_id, user_id)
			send_large_msg(receiver, " ["..user_id.."] Removed From Silented User List\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM")
		elseif is_owner(extra.msg) then
			mute_user(chat_id, user_id)
			send_large_msg(receiver, " ["..user_id.."] Added To Silented User List\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM")
		end
	end
end
...
local function run(msg, matches)
  ...
  if matches[1]:lower() == 'me' and is_momod(msg) then
    ...
    return "You Are An Admin :)"
		...
		if matches[1] == "silent" or matches[1] == "unsilent" and is_momod(msg) then
			...
			elseif matches[1] == "silent" or matches[1] == "unsilent" and string.match(matches[2], '^%d+$') then
				...
				if is_muted_user(chat_id, user_id) then
					unmute_user(chat_id, user_id)
					savelog(msg.to.id, name_log.." ["..msg.from.id.."] Removed ["..user_id.."] From The Silented Users List\n\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM")
					return "["..user_id.."] Removed From The Silented Users List\n\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM"
	...
	--savelog(msg.to.id, name_log.." ["..msg.from.id.."] added ["..user_id.."] to the muted users list\n\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM")
					return "["..user_id.."] Added To The Silented User List\n\nCreated By @To_My_Amigos\nOur Channel @AntiSpam_TM"
				end
